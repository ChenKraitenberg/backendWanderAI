...
describe('API Validation Tests', () => {
    ...
    test('Post update should reject updates from non-owners', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const updateResponse = yield (0, supertest_1.default)(server).put(`/posts/${postId}`).set('Authorization', `Bearer ${secondUserToken}`).send(updateData);
        expect([403, 404]).toContain(updateResponse.statusCode);
