...
describe('Posts Controller Tests', () => {
    ...
    describe('Post Update', () => {
        test('Should update post as owner', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const response = yield (0, supertest_1.default)(app).patch(`/posts/${testPostId}`).set('Authorization', `JWT ${accessToken}`).send(updateData);
            expect(response.status).toBe(200);
        ...
        test('Should reject update without authentication', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Changed PUT to PATCH
            const response = yield (0, supertest_1.default)(app).patch(`/posts/${testPostId}`).send(updateData);
            expect(response.status).toBe(401);
        }));
        test('Should reject update for non-existent post', () => __awaiter(void 0, void 0, void 0, function* () {
            const fakeId = new mongoose_1.default.Types.ObjectId().toString();
            // Changed PUT to PATCH
            const response = yield (0, supertest_1.default)(app).patch(`/posts/${fakeId}`).set('Authorization', `JWT ${accessToken}`).send({ name: 'Updated Name' });
            expect(response.status).toBe(404);
        }));
        test('Should reject update by non-owner', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Changed PUT to PATCH
            const response = yield (0, supertest_1.default)(app).patch(`/posts/${testPostId}`).set('Authorization', `JWT ${anotherUserToken}`).send({ name: 'Unauthorized Update' });
    ...
    describe('Pagination and Filtering', () => {
        ...
        test('Should validate date range during post operations', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const updateResponse = yield (0, supertest_1.default)(app).patch(`/posts/${postId}`).set('Authorization', `JWT ${accessToken}`).send(invalidDatePost);
